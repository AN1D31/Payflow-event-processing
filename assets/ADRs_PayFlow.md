...
- ✅ Reintentos automáticos reducen intervención manual del equipo de infraestructura (una sola persona)
...
- ⚠️ El equipo debe aprender el modelo de consistencia de Cosmos DB y el diseño de partition keys (se recomienda usar `comercioId` como partition key para localizar transacciones por comercio)
- ⚠️ Las consultas analíticas históricas (reportes por rango de fechas entre comercios) pueden consumir muchas RU/s; para reportes complejos se recomienda exportar a Azure Synapse en el futuro
...
- ❌ Costo significativo: desde $15 USD/host/mes, incompatible con el presupuesto de $50 USD/mes total
